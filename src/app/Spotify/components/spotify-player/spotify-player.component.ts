...
export class SpotifyPlayerComponent implements OnInit {
  ...
  constructor(
    ...
    private spotifyPlayerSvc: SpotifyPlayerService
  ) {}
  ...
  ngOnInit(): void {
    ...
    this.playbackChanged = this.spotifySvc.onPlaybackChanged.subscribe(
      this.getPlaybackInfo.bind(this)
    );
  ...
  goToPreviousSong() {
    this.spotifyPlayerSvc
      .goToPreviousSong()
      .subscribe(this.getPlaybackInfo.bind(this));
  }
